$(document).ready(function(){
	...
	var player1 = "<div class='player draggable player1' id='' data='6,3'></div>";
	var player2 = "<div class='player draggable player2' id='' data='0,3'></div>";
	...
	//$( ".draggable" ).draggable( "option", "scope", "drop" );
	 ...
	 var row = new Array(7);
	 row.fill(0);
	 var gameState = new Array(7);
	 gameState.fill(row);
	 console.log(gameState);
	 */
	 var gameState = Array.from({length:7}, () => {
		var row = new Array(7);
		row.fill(0);
		return row;
	});
